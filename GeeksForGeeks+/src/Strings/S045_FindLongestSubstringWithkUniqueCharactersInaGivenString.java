 ...
 */
public class S045_FindLongestSubstringWithkUniqueCharactersInaGivenString {
	...
	public void kUniques(String s, int k){
	...
	public static void main(String[] args) {
		S045_FindLongestSubstringWithkUniqueCharactersInaGivenString obj = new S045_FindLongestSubstringWithkUniqueCharactersInaGivenString();
		String s = "aaabbb";
	    int k = 3;
	    obj.kUniques(s, k);
	}
