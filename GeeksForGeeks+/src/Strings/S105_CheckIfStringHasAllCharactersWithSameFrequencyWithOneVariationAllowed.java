package Strings;
/*
 * http://www.geeksforgeeks.org/check-if-a-String-has-all-characters-with-same-frequency-with-one-variation-allowed/
 */
public class S105_CheckIfStringHasAllCharactersWithSameFrequencyWithOneVariationAllowed {

	// Assuming only lower case characters
	static int CHARS = 26;
	 
	/* To check a String S can be converted to a “valid”
	   String by removing less than or equal to one character.
	 */
