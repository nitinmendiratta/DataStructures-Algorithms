 ...
 */
public class S065_KthNonRepeatingCharacter {

	int MAX_CHAR = 256;
	// Returns index of k'th non-repeating character in given string str[]
	public int kthNonRepeating(String str, int k){
	    int n = str.length();
	...
	public static void main(String[] args) {
		S065_KthNonRepeatingCharacter obj = new S065_KthNonRepeatingCharacter();
		String str = "geeksforgeeks";
		   int k = 3;
		   int res = obj.kthNonRepeating(str, k);
		   if(res == -1){
			   System.out.println("There are less than k non-repeating characters");
		   }else{
			   System.out.println("k'th non-repeating character is: "+str.charAt(res));
		   }
	}
