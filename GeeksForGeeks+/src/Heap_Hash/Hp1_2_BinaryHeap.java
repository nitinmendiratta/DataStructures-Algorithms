 ...
 * worst case complexity looks like O(nLogn), upper bound of time complexity is O(n)
 */
public class Hp1_2_BinaryHeap {
	...
	/** Constructor **/    
	public Hp1_2_BinaryHeap(int capacity){
		heapSize = 0;
	...
	public static void main(String[] args){
		...
		Hp1_2_BinaryHeap bh = new Hp1_2_BinaryHeap(scan.nextInt() );
