 ...
 * 
 */
public class A134_GenerateAllPossibleSortedArraysFromAlternateEltsOf2GivenSortedArrays {
    ...
    combinations */
	 public void generateUtil(int A[], int B[], int C[], int i, int j, int m, int n, int len, boolean flag) {
	...
	public static void main(String[] args) {
		A134_GenerateAllPossibleSortedArraysFromAlternateEltsOf2GivenSortedArrays generate = new A134_GenerateAllPossibleSortedArraysFromAlternateEltsOf2GivenSortedArrays();
        int A[] = {10, 15, 25};
        int B[] = {5, 20, 30};
        int n = A.length;
        int m = B.length;
