 ...
 * O(n)
 */
public class A119_FindSmallestValueRepresentedSumSubsetGivenArray {
	...
	public static void main(String[] args) {
		A119_FindSmallestValueRepresentedSumSubsetGivenArray small = new A119_FindSmallestValueRepresentedSumSubsetGivenArray();
        int arr1[] = {1, 3, 4, 5};
        int n1 = arr1.length;
