 ...
 * O(n)
 */
public class A120_RearrangeArrayArrjBecomesArrij {
    ...
    // if arr[i-1] is j+1
    public void rearrangeUtil(int arr[], int n, int i) {
	...
	public static void main(String[] args) {
		A120_RearrangeArrayArrjBecomesArrij arrange = new A120_RearrangeArrayArrjBecomesArrij();
        int arr[] = {2, 0, 1, 4, 5, 3};
        int n = arr.length;
