 ...
 */
public class E_1042_FlowerPlantingWithNoAdjacent {
	...
	public static void main(String[] args) {
		E_1042_FlowerPlantingWithNoAdjacent obj = new E_1042_FlowerPlantingWithNoAdjacent();
		System.out.println(obj.gardenNoAdj(3, new int[][] {{1,2},{2,3},{3,1}}));
	}
}
