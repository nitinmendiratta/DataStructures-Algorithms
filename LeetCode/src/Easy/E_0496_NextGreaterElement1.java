 ...
 */
public class E_0496_NextGreaterElement1 {

	/*
	 * Suppose we have a decreasing sequence followed by a greater number For
	 * example [5, 4, 3, 2, 1, 6] then the greater number 6 is the next greater
	 ...
	 * popped ones, their next greater element is x For example [9, 8, 7, 3, 2, 1, 6] 
	...
	public static void main(String[] args) {
		E_0496_NextGreaterElement1 obj = new E_0496_NextGreaterElement1();
